...
// Consumer
//========================================================================
var Consumer = function (queue, opts) {
...
Consumer.prototype.consume = function (channel, callback) {
    ...
    return Promise.resolve(true)
        ...
        .then(() => channel.consume(this.queue.name, (msg) => this.processMessage(msg), this.opts))
        .then((ok) => {
...
Consumer.prototype.processMessage = function (msg) {
    ...
    var ch = this.channel;
    console.log('EventEmmiter:', this instanceof require('events'));
